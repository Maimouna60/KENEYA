...
<!-- header -->
    ...
    <section>
      ...
      <div class="search">
          ...
          <input class="form-control my-0 py-1 aqua-gradient-border ml-5" type="text" placeholder="Search" aria-label="Search">
            <div class="input-group-append">
              <span class="input-group-text aqua-gradient lighten-3" id="basic-text1"><i class="fas fa-search text-grey"
              aria-hidden="true"></i></span> 
            </div>
          </div>
      </div>
        <div class="text-center Testimony ">
        <h2 class="font-style: italic; text-info mb-4 mt-4">Nos Praticiens témoignent!</h2> 
          <!-- Container -->
        ...
        <div class=" mt-3 col-md-4 d-flex align-items-stretch">
          <div class="card">
             ...
             <div class="card-body">
                 ...
                 <p class="card-text" style="font-style: italic;">"On un mot "parfaite", 
      ...
      <div class="mt-3 col-md-4 d-flex align-items-stretch">
        <div class="card">
           ...
           <div class="card-body">
               ...
               <p class="card-text" style="font-style: italic;">"C'est une application que je conseil vivement
                Elle m'aide aujoud'hui quotidiennement, notamment pour le suivi      
                de grossesse de mes patientes donc les conjoints sont à l'etranger.              
