<?php include_once 'models/Moncompteform.php';
 include 'controllers/MoncompteformController.php'?>
<div class="teext-primary">
        ...
        <div class="container"> 
            ...
            <div class="row ">
                ...
                <div id="login">
                    ...
                    <div class="box_form ">
                        <form id="form1" action="Moncompte-form" method="POST">
                            <div class="row">
                                <div class="col-12">
                            ...
                            <div id="mailInput" class="form-group <?= count($_POST) > 0 ? (isset($formErrors['mail']) ? 'has-danger' : 'has-success') : '' ?>">
                                ...
                                <input oninput="checkmail()" type="text" id="mail" name="mail" placeholder="Ex : Mai.kine@gmail.com" class="form-control <?= count($_POST) > 0 ? (isset($formErrors['mail']) ? 'is-invalid' : 'is-valid') : '' ?>" <?= isset($_POST['mail']) ? 'value="' . $_POST['mail'] . '"' : '' ?> />
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group add_top_20">
                                        <button type="submit" class="btn btn-primary text-uppercase"  name="connexion" style="width: 100%"> <a href="profil-patient.php?&id=<?= $patient->id ?>">Se Connecter</a></button>
                                    </div>
                                </div>
                            </div>
                        <div class="row">
